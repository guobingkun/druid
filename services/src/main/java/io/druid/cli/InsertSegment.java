...
public class InsertSegment extends GuiceRunnable
{
  ...
  @Option(name = "--workingDir", description = "The directory where segments and their descriptor.json reside", required = true)
  private String workingDirPath;

  @Option(name = "--updateDescriptor", description = "Update descriptor.json if the location of the segment changes", required = false)
