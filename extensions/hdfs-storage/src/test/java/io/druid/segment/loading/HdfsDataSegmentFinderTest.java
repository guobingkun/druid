...
public class HdfsDataSegmentFinderTest
{
  ...
  public void testFindSegments() throws Exception
  {
    ...
    Assert.assertEquals(descriptor1.toString(), getDescriptorPath(updatedSegment1));
    Assert.assertEquals(descriptor2.toString(), getDescriptorPath(updatedSegment2));
    Assert.assertEquals(descriptor3.toString(), getDescriptorPath(updatedSegment3));
    Assert.assertEquals(descriptor4_0.toString(), getDescriptorPath(updatedSegment4_0));
    Assert.assertEquals(descriptor4_1.toString(), getDescriptorPath(updatedSegment4_1));
